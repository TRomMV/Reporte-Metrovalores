...
sector_real = [
    ...
    'HOLCIM ECUADOR S.A.', 'SAN CARLOS SOC. AGR. IND.', 'CONCLINA C A CIA CONJU CLINICO NACIONAL', 'CONTINENTAL TIRE ANDINA S A', 'INVERSANCARLOS', 'INDUSTRIAS ALES', 'BRIKAPITAL SA'
]
